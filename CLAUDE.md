...
python scripts/generate_ollama_rss.py         # → dist/ollama-models.xml
...
python -m pytest tests/ollama/ -v                   # Ollama固有テスト
...
| `generate_ollama_rss.py` | HTML構造解析（search page） | ❌ 不要 |
...
| `rss-ollama-models.yml` | 毎日 23:00 | ❌ |
